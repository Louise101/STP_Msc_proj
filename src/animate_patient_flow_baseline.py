...
EVENT_LOG_PATH = OUTPUT_DIR / "baseline_mc_events.csv"
...
# Animation output
OUTPUT_GIF = OUTPUT_DIR / "patient_flow_animation_baseline.gif"
OUTPUT_MP4 = OUTPUT_DIR / "patient_flow_animation_baseline.mp4"
